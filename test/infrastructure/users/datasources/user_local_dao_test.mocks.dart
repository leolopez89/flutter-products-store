...
// in flutter_products_store/test/infrastructure/users/datasources/user_local_dao_test.dart.
...
class MockGetStorage extends _i1.Mock implements _i2.GetStorage {
  ...
  @override
  _i6.VoidCallback listen(_i6.VoidCallback? value) => (super.noSuchMethod(
        Invocation.method(
          #listen,
          [value],
        ),
  ...
  @override
  _i6.VoidCallback listenKey(
    String? key,
    _i7.ValueSetter<dynamic>? callback,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #listenKey,
